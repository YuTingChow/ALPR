...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/licensePlate.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='data/hyp.scratch-LPreg.yaml', help='hyperparameters path')
